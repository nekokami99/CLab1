...
public class Test {
    public static void main(String[] args) {
        ...
        restaurantOrder.add(new Drink(5,"CocaCola", "drink"));
        restaurantOrder.add(new Drink(5,"Pepsi", "drink"));
        restaurantOrder.add(new Dish(3,"Soup", "dish"));
        ...
        internetOrder.add(new Dish(4,"Cake", "dish"));
        internetOrder.add(new Dish(1,"Ice Cream", "dish"));
